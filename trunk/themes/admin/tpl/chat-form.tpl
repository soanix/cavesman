<div id="chat-form" class="fixed">
    <div class="chat-inner">
        <h2 class="chat-header">
            <a href="javascript:;" class="chat-form-close pull-right"><i class="fa fa-trash">
    ...
    <div id="chat-box" style="top: 400px">
        <div class="chat-box-header">
            <a href="#" class="chat-box-close pull-right"><i class="fa fa-trash">
        ...
        <div class="chat-content">
            <ul class="chat-box-body">
                <li>
                    <p>
                        <img src="{$img}/avatar/128.jpg" class="avt" /><span class="user">John Doe</span><span
                ...
                <li class="odd">
                    <p>
                        <img src="{$img}/avatar/48.jpg" class="avt" /><span class="user">Swlabs</span><span
                            class="time">09:33</span></p>
                    <p>
